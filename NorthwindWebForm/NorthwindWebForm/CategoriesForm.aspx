<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoriesForm.aspx.cs" Inherits="NorthwindWebForm.CategoryTable" %>
                        ...
                        <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>                             
                                    <asp:LinkButton ID="btEdit" runat="server" CausesValidation="false" CommandName="Edit"
                                            Text="Edit" CommandArgument='<%# Eval("CategoryId") %>' />
                                </ItemTemplate>                                            
                            </asp:TemplateField>
                    </Columns>
                </asp:GridView>
